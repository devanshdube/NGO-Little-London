...
export default function Certificate({
  ...
  //   return (
  //     <div className="min-h-screen bg-[#f6b13b] flex items-center justify-center p-6 box-border">
  //       <div className="relative w-full max-w-[1200px] rounded-md shadow-2xl overflow-hidden bg-gradient-to-b from-[#fff7ea] to-[#fff9ef]">
  //         {/* Orange border */}
  //         <div
  //           className="absolute inset-0 rounded-md"
  //           style={{
  ...
  //           </defs>
  //           <path
  //             d="M400 0 C260 40 260 360 400 400 L400 0 Z"
  //             fill="url(#g1)"
  //             opacity="0.08"
  //           />
  //           <path
  //             d="M400 0 C300 20 300 380 400 400 L400 0 Z"
  //             fill="url(#g1)"
  //             opacity="0.14"
  //           />
  //         </svg>
